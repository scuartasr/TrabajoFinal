...
```
vemos el dato que numero que mas se repite es cero con una frecuencia de 301 además como se puede ver en el gráfico de barra el número de comentarios varia mucho, y es evidente que un número de comentarios mas pequeño es lo más frecuente para una publicación.
